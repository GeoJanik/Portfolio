...
<h2>Missions ! velo</h2>
<p>Pour débuter chez nous, je souhaite que tu t’occupes de la refonte de notre site, qui n’a pas été mis à jour depuis
    plusieurs mois. <br>
    <br>
    ...
    La présentation orale a, elle aussi, été de nouveau préparée. Le projet respecte le cahier des charges, il est donc
    validé<div class="br"></div>
    <br>
    ...
    <br>
    La présentation orale est dynamique et agréable à suivre. L’étudiant utilise son support de présentation pour
    montrer le code source du site, et il développe et justifie à l’oral ses choix. Le rôle d’un intégrateur est
    compris, et les difficultés rencontrées bien identifiées. <br>
    <br>
